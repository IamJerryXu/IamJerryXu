...
def copy_block(name, paragraphs, mobile, mode, p):
    ...
    highlights={'Sun Yat-sen University':p['green'], 'InkMind.AI':p['green'],
                ...
                'research tools':p['ink'], 'AI builds AI':p['ink']}
...
def build():
    for mode in ['light','dark']:
        ...
        for mobile in [False,True]:
            ...
            copy_block('bio', ["I'm an undergraduate at Sun Yat-sen University and a member of InkMind.AI.", "I'm interested in generation as a way to understand the visual world — how it changes, and how we can interact with it.", "With the team, I build research tools through vibe coding and explore RSI and auto-research workflows that help AI frame questions, build systems, evaluate results, and iterate. We see AI builds AI as a direction worth exploring."], mobile, mode, p)
